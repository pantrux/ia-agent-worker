...
| ID | Entregable | PR / referencia | Estado | Notas |
|----|------------|-----------------|--------|-------|
| B1 | AI Gateway (PoC staging → prod) | [PR #7](https://github.com/pantrux/ia-agent-worker/pull/7) (merge 2026-05-13); [PR #20](https://github.com/pantrux/ia-agent-worker/pull/20) (merge 2026-05-15); [`5285b0a`](https://github.com/pantrux/ia-agent-worker/commit/5285b0a) (2026-05-15) | Ejecutado | PR #7: enrutado opcional `…/compat`. PR #20: gateway + proveedor Copilot, provision dual, cabeceras IDE, `base_url` sin path duplicado. **`5285b0a`:** Copilot por gateway usa **`/compat`** + modelo `custom-{slug}/…` para mitigar **400/código 2005** del gateway con la ruta `…/custom-{slug}/v1/…`. |
