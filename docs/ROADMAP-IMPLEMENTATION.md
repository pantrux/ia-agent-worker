...
| ID | Entregable | PR / referencia | Estado | Notas |
|----|------------|-----------------|--------|-------|
| B1 | AI Gateway (PoC staging → prod) | [PR #7](https://github.com/pantrux/ia-agent-worker/pull/7) (merge 2026-05-13) | Ejecutado | PoC: `src/ai-gateway.ts`, `src/llm-client.ts`, README; vars opcionales `AI_GATEWAY_*`. Dashboard: custom provider según proveedor. |
