...
| B2 | Métricas Worker + dashboards LangSmith | — | En curso | Guía operativa [B2-worker-metrics-langsmith.md](./B2-worker-metrics-langsmith.md); PR al abrirse enlazará aquí. Issue [PAN-7](https://linear.app/pantrux/issue/PAN-7/b2-metricas-worker-dashboards-langsmith). |
...
| 2026-05-15 | **B2 / PAN-7:** documentación métricas Worker (Observability + `ia_agent_access`) y dashboards LangSmith; ver [B2-worker-metrics-langsmith.md](./B2-worker-metrics-langsmith.md) y PR asociado al merge. |
