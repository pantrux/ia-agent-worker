...
export interface Env {
  ...
  /**
   * Recuperación del token LLM: variable en texto plano (Workers → Settings → Variables).
   ...
   * No es obligatorio borrar el secreto `COPILOT_GITHUB_TOKEN` ni esta clave al terminar; limita quién conoce la URL y el valor de `k`.
   */
